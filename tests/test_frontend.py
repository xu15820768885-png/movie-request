...
class FollowFeatureVisibilityTest(unittest.TestCase):
    def test_native_follow_and_automatic_wash_controls_are_visible(self):
        ...
        self.assertIn('id="guanyingEnabled"', html)
        self.assertIn("参与自动追更和洗版", html)
        self.assertIn('id="dianFollowEnabled"', html)
        self.assertIn('id="dianFollowInterval"', html)
        self.assertIn('<option value="10800">每3小时</option>', html)
        self.assertIn('id="washDefaultDays"', html)
        self.assertIn('<option value="2">2天</option>', html)
        self.assertNotIn('<option value="14">14天</option>', html)
        self.assertNotIn('一直洗版</option>', html)
        self.assertIn('data-follow-wash-window=', html)
        self.assertIn('/wash-window', html)
